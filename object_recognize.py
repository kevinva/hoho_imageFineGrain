...
if __name__ == '__main__':
    ...
    image_path = '../data/cub_200_2011/CUB_200_2011/images/032.Mangrove_Cuckoo/Mangrove_Cuckoo_0011_26406.jpg'
    ...
    # im_x = transform(im).unsqueeze(0)            # [1, 3, 224, 224]， patch size: [16, 16]
    # print(im_x.size())
    # print(np.array(im).shape)

    # features, att_mat = encoder(im_x)            
    # att_mat = torch.stack(att_mat).squeeze(1)    # [12 (layers), 12 (heads), 197, 197]
    # att_mat = torch.mean(att_mat, dim=1)         # [12, 197, 197]
    # residual_att = torch.eye(att_mat.size(1))    # [197, 197]
    # aug_att_mat = att_mat + residual_att         # [12, 197, 197]
